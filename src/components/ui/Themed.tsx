...
export function ThemedButton({
  ...
  const color =
    kind === 'primary' ? colors.primaryText : kind === 'plain' ? colors.primary : colors.text;
  return (
    <TouchableOpacity
      ...
      style={[
        {
          ...
          borderColor: border,
          borderWidth: 1,
          paddingVertical: size === 'large' ? 14 : size === 'compact' ? 8 : 12,
          paddingHorizontal: size === 'large' ? 18 : size === 'compact' ? 10 : 16,
