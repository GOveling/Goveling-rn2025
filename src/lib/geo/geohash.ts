/**
 * Geohash encoder/decoder for client-side caching
...
/**
 * Get neighboring geohashes (for pre-caching)
 */
export function neighbors(geohash: string): string[] {
  // Simplified: return the same for now
  // Full implementation would return 8 adjacent cells
  return [geohash];
}
