/*
  ...
  FIXED VERSION: Added DROP POLICY IF EXISTS to handle existing policies
*/
...
DROP POLICY IF EXISTS "Authenticated users can access directions cache" ON public.directions_cache;
