...
export default function Booking(){
  ...
  return (
    <View style={{ padding:16 }} accessibilityLabel='Booking hub' accessibilityRole='summary'>
      ...
      <BookingCard title="Flights" subtitle="Busca vuelos y abre tu afiliado" cta="Buscar vuelos" onPress={()=> router.push('/booking/flights')} subtitle="Busca vuelos y abre tu afiliado" cta="Buscar vuelos" onPress={()=> router.push('/booking/flights')} />
