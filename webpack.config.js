...
module.exports = async function (env, argv) {
  ...
  const definitions = {
    ...
    'process.env': {
      ...
      EXPO_PUBLIC_SUPABASE_ANON_KEY: JSON.stringify(
        process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || ''
      ),
      EXPO_PUBLIC_GOOGLE_OAUTH_CLIENT_IOS: JSON.stringify(
        process.env.EXPO_PUBLIC_GOOGLE_OAUTH_CLIENT_IOS || ''
      ),
      EXPO_PUBLIC_GOOGLE_OAUTH_CLIENT_ANDROID: JSON.stringify(
        process.env.EXPO_PUBLIC_GOOGLE_OAUTH_CLIENT_ANDROID || ''
      ),
      ...
      EXPO_PUBLIC_ML_PRIMARY_VERSION: JSON.stringify(
        process.env.EXPO_PUBLIC_ML_PRIMARY_VERSION || ''
      ),
